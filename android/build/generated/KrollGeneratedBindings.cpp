...
namespace titanium {
	namespace bindings {
		...
		class BluetoothmanagerBindings {
			public:
				static BindEntry* lookupGeneratedInit(const char*, unsigned int);
		};

		BindEntry* BluetoothmanagerBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"de.appwerft.bluetoothmanager.BluetoothmanagerModule", ::de::appwerft::bluetoothmanager::BluetoothmanagerModule::bindProxy, ::de::appwerft::bluetoothmanager::BluetoothmanagerModule::dispose}
			};
